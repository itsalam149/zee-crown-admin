    ...
    return (
        <div className="min-h-screen bg-black text-gray-300 font-sans p-6 md:p-12 relative overflow-hidden">
            ...
            <div className="relative z-10 max-w-screen-xl mx-auto">
                <div className="mb-8">
                    <Link href="/dashboard/products" className="inline-flex items-center space-x-2 text-green-400 hover:text-green-300 transition-colors">
                        <ArrowLeft size={20} />
                        <span>Back to All Products</span>
                    </Link>
                </div>

                {/* New centered layout grid */}
                <div className="grid grid-cols-1 md:grid-cols-5 gap-12 items-start">
                    {/* Left Column (Smaller Image) with glassmorphism container */}
                    ...
                    <div className="md:col-span-3 flex flex-col h-full">
                        <div className="space-y-6">
                            ...
                            <h1 className="text-5xl lg:text-6xl font-black text-white leading-tight">{product.name}</h1>
                            ...
                            <div>
                                <h2 className="text-xl font-bold text-white mb-3">About this product</h2>
