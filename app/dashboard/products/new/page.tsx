...
export default function NewProductPage() {
    ...
    const [formData, setFormData] = useState({
        ...
        description: '',
        price: '',
        category: 'medicine' as 'medicine' | 'cosmetics' | 'food' | 'perfumes',
    });
    ...
    return (
        <div className="min-h-screen bg-black text-gray-300 p-6 md:p-12">
            <div className="max-w-4xl mx-auto">
                ...
                <form onSubmit={handleCreate} className="p-8 space-y-8 backdrop-blur-lg bg-black/30 rounded-2xl border border-green-500/20 shadow-lg shadow-green-900/20">
                    ...
                    <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                        <div className="space-y-2">
                            ...
                            <input id="price" name="price" type="text" inputMode="decimal" value={formData.price} onChange={handleChange} placeholder="e.g., 1250.50" className="w-full bg-black/30 border-2 border-gray-700 text-white rounded-lg px-4 py-3 focus:outline-none focus:ring-2 focus:ring-emerald-500 transition-colors" required />
                        </div>
                        <div className="space-y-2">
                    ...
                    <div className="space-y-2">
                        <label htmlFor="image_file" className="block text-sm font-semibold text-gray-300">Product Image</label>
                        <input
                            id="image_file"
                            name="image_file"
                            type="file"
