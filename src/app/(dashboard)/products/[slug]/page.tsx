...
export async function generateMetadata({
  ...
  try {
    const { product } = await fetchProductDetails(createServerClient(), { id: slug });
      ...
      <section>
        ...
        <div className="flex flex-col gap-6 lg:gap-8 md:flex-row mb-6">
          <div className="flex-shrink-0 w-full max-w-80 mx-auto md:mx-0 md:max-w-72  xl:max-w-80">
            <Image
              src={product.image_url || "/assets/not-found.png"}
          ...
          <div className="flex flex-col xl:pr-12">
            ...
            <Typography component="p" className="mb-3">
              ...
              <Typography className="text-foreground/60">{product.category}</Typography>
            </Typography>
            ...
            <Typography component="p" className="mb-6">
              ...
              <Typography className="text-foreground/60">{product.expiry_date || "—"}</Typography>
            </Typography>
